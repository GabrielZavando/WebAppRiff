...
## Purpose
Convención canónica de assets de imagen del sitio público Astro (`apps/web`): ubicaciones físicas de los binarios, consumo obligatorio vía `astro:assets`, dependencia de pipeline (`sharp`) y la única excepción 1:1 a `public/` (imagen Open Graph).
